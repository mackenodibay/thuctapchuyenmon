...
public partial class cms_admin_SanPham_QuanLyNhomSanPham_NhomSanPham_ThemMoi : System.Web.UI.UserControl
{
    ...
    private void HienThiThongTin(string id)
    {
        if (thaotac == "ChinhSua")
        {
            ...
            dt = Webbanhang.NhomSanPham.Thongtin_Nhomsp_by_id(id);
            if (dt.Rows.Count > 0)
            {
    ...
    protected void btThemMoi_Click(object sender, EventArgs e)
    {
        if (thaotac == "ThemMoi")
        {
            ...
            Webbanhang.NhomSanPham.Nhomsanpham_Inser(tbTenNhomSP.Text, flAnhDaiDien.FileName, tbThuTu.Text, tbSoSanPhamHienThi.Text, "");
        ...
        else
        {
            ...
            Webbanhang.NhomSanPham.Nhomsanpham_Update(id, tbTenNhomSP.Text, tenAnhDaiDien, tbThuTu.Text, tbSoSanPhamHienThi.Text);
