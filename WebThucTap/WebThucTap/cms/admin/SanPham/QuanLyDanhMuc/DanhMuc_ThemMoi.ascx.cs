...
public partial class cms_admin_SanPham_QuanLyDanhMuc_DanhMuc_ThemMoi : System.Web.UI.UserControl
{
    ...
    private void HienThiThongTin(string id)
    {
        if(thaotac=="ChinhSua")
        {
            ...
            dt = Webbanhang.DanhMuc.Thongtin_Danhmuc_by_id(id);
            if(dt.Rows.Count>0)
            {
    ...
    {
        DataTable dt = new DataTable();
        dt = Webbanhang.DanhMuc.Thongtin_Danhmuc_by_MaDMCha(MaDMCha);
    ...
    protected void btThemMoi_Click(object sender, EventArgs e)
    {
        if(thaotac=="ThemMoi")
        {
            ...
            Webbanhang.DanhMuc.Danhmuc_Inser(tbTenDanhMuc.Text, flAnhDaiDien.FileName, tbThuTu.Text, ddlDanhMucCha.SelectedValue, "");
        ...
        else
        {
            ...
            Webbanhang.DanhMuc.Danhmuc_Update(id, tbTenDanhMuc.Text, tenAnhDaiDien, tbThuTu.Text, ddlDanhMucCha.SelectedValue);
